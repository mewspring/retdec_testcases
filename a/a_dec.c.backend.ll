...
@1 = constant [3 x i16] %wide-string
@global_var_402750.16 = constant i32 -1
@initialized = local_unnamed_addr global i32 0
@global_var_404068.24 = constant [31 x i8] c"Argument domain error (DOMAIN)\00"
@global_var_404087.25 = constant [28 x i8] c"Argument singularity (SIGN)\00"
@global_var_4040a4.26 = constant [32 x i8] c"Overflow range error (OVERFLOW)\00"
@global_var_4040c4.27 = constant [54 x i8] c"The result is too small to be represented (UNDERFLOW)\00"
@global_var_4040fc.28 = constant [35 x i8] c"Total loss of significance (TLOSS)\00"
@global_var_404120.29 = constant [37 x i8] c"Partial loss of significance (PLOSS)\00"
@2 = internal constant [8 x i8] c"\83\EC<\B9,@@\00"
@global_var_404000.14 = constant [3 x i16] %wide-string
...
entry:
  call void @__main()
  %v3_4015af = call i32 (i16*, ...) @wprintf(i16* getelementptr inbounds ([3 x i16], [3 x i16]* @global_var_404000.14, i32 0, i32 0))
  ret i32 0
}
...
entry:
  ...
  %v4_4017192 = load i32, i32* inttoptr (i32 add (i32 ptrtoint (i32* @global_var_402750.16 to i32), i32 4) to i32*), align 4
...
dec_label_pc_4016f3:                              ; preds = %dec_label_pc_401724, %dec_label_pc_4016f3
  ...
  %v6_4016f3 = add i32 %v5_4016f3, ptrtoint (i32* @global_var_402750.16 to i32)
...
dec_label_pc_401714:                              ; preds = %entry, %dec_label_pc_401714
  ...
  %v2_401719 = add i32 %v1_401719, ptrtoint (i32* @global_var_402750.16 to i32)
...
; uselistorder directives
  ...
  uselistorder i32 ptrtoint (i32* @global_var_402750.16 to i32), { 1, 2, 0 }
...
; uselistorder directives
  ...
  uselistorder i32 0, { 9, 3, 7, 8, 4, 5, 0, 1, 2, 6, 10 }
}
